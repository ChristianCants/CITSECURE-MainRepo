...
const SignUp = () => {
  ...
  const handleRegistration = () => {
    ...
    axios.post('http://localhost:8080/user/insertUser', userData)
      .then(response => {
        console.log('Registration successful:', response.data);
        navigateToLogin(); // Navigate to login page after successful registration
      })
      .catch(error => {
              ...
              <div className="card-body px-4 py-5 px-md-5">
                <form>
                  ...
                  <button
                    ...
                    onClick={handleRegistration} // Trigger registration on button click
                  >
                    Register
                  </button>
