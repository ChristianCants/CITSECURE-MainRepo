                ...
                <div>
                    ...
                    >
                        ...
                        <Carousel.Item>
                            <img
                                className="d-block w-100"
                                src="images/ACAD CES NSTP.jpg"
                                alt="Acad CES NSTP"
                                style={{ height: '800px', width: '100%', objectFit: 'cover' }}
                            />
                            <Carousel.Caption style={carouselCaptionStyle}>
                                <div style={{ color: 'black', display: 'flex', flexDirection: 'column' }}>
                                    <h5>Community Extension Services & National Service Training Program</h5>
                                    <p>Need Details</p>
                                </div>
                            </Carousel.Caption>
                        </Carousel.Item>
