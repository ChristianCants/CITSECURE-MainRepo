...
class BackgateMainCanteen extends Component {
    handleGoBack = () => {
            ...
            <>
                ...
                >
                    ...
                    <ul className="nav nav-pills d-flex justify-content-center" style={{ margin: 0, padding: 0, flexGrow: 1 }}>
                        ...
                        <li className="nav-item"><span className="nav-link active" style={{ color: 'maroon', backgroundColor: 'white', cursor: 'pointer' }}>MainCanteen Building</span></li>
                ...
                <Container fluid style={{ backgroundColor: '#ebebeb', display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '80vh' }}>
                    <Row className="justify-content-center">
                        <Col sm={12} className="d-flex justify-content-center">
                            <img
                                src="/images/MainCanteenMap (Back).png"
                                alt="High School Map"
                                style={{
                                    width: '60%',
                                    height: 'auto',
...
export default BackgateMainCanteen;
