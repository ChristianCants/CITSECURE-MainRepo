...
<div style={{ display: 'flex', justifyContent: 'space-between', color: 'maroon', marginBottom: '20px', padding: '0 20px' }}>
<p>2023 CIT NaviGo. All rights reserved.</p>
<p>
  <a href="/terms-and-conditions" style={{ color: 'maroon', marginRight: '20px' }}>Terms and Conditions</a> 
  |
  <a href="/privacy-policy" style={{ color: 'maroon', marginLeft: '10px' }}>Privacy Policy</a>
</p>
</div>
